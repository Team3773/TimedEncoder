...
public class Robot extends TimedRobot {
  ...
  private WPI_TalonSRX leftMaster = new WPI_TalonSRX(7);
   ...
   * autonomous modes using the dashboard. The sendable chooser code works with the Javait
  ...
  public void autonomousPeriodic() {
    ...
    // Motor output
    leftSlave.set(outputSpeed);
    leftMaster.set(outputSpeed);
    rightSlave.set(-outputSpeed);
    rightMaster.set(-outputSpeed);
    }
